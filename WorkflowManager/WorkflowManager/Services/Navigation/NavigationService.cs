...
using WorkflowManager.Services.Settings;
    ...
    public class NavigationService : INavigationService
    {
        ...
        public ViewModelBase PreviousPageViewModel
        {
            get
            {
                ...
                var viewModel = mainPage.Navigation
                    .NavigationStack[mainPage.Navigation.NavigationStack.Count - 2].BindingContext;
        ...
        {
            Page page = this.CreatePage(viewModelType, parameter);
